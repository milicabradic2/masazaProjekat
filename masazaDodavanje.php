	...
	<body>
      ...
      <?php include 'header.php'; ?>
		...
		<div id="glavni-work-section">
			<div class="container">
          <h1 class="naslov text-center"> Dodaj masažu </h1>
          <form method="POST" action="add.php">
            <label for="nazivMasaze">Naziv masaže</label>
            <input type="text" class="form-control" placeholder="Unesite naziv masaze" name="naziv" id="nazivMasaze">
            <label for="cena">Osnovna cena</label>
            <input type="number" class="form-control" placeholder="Unesite osnovnu cenu masaze" name="cena" id="cena">
            <label for="tip">Tip masaže</label>
            <select class="form-control"name="tip" id="tip">
            </select>
            <label for="trajanje">Trajanje masaže</label>
